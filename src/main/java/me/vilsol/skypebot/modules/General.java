...
public class General implements Module {
    ...
    @Command(name = "8ball")
    public static void cmd8Ball(ChatMessage chat, String question) throws SkypeException {
        ...
        R.s("[" + chat.getSenderDisplayName() + "] " + question + ": " + options[chosen]);
    }
    ...
    @Command(name = "rant")
    public static void cmdRant(ChatMessage chat, @Optional
