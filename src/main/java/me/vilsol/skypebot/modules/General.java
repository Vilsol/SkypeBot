...
public class General implements Module {
    ...
    public static void cmdAbout(String message){
        R.s(new String[] {"Skype bot made by Vilsol", "Version: " + R.version});
    }

    @Command(name = "nvc")
    public static void cmdNVC(String message){
        String[] nvc = {"What the fuck did you just fucking say about me, you little bitch?",
                ...
                "Not only am I extensively trained in unarmed combat, but I have access to the entire arsenal of the United States Marine Corps and I will use it to its" +
                "full extent to wipe your miserable ass off the face of the continent, you little shit.",
