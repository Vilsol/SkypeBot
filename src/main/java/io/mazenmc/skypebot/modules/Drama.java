...
public class Drama implements Module {
    ...
    private static HashMap<String, String[]> data = new HashMap<String, String[]>() {{
        put("people", new String[]{"jeb", "Notch", "Mojang", "Curse", "Searge", "mbaxter", "Garrison", "RawCode", "Vilsol", "md_5", "sk89q", "MazenMC", "hawkfalcon", "New Bukkit Staff", "Wolvereness", "CaptainBern", "Hoolean", "drtshock", "EvilSeph", "TnT", "lukegb", "codename_B", "Cryptkeeper", "hintss", "Saad", "Obama", "TheMogMiner", "TridentSDK Staff", "Reddit's Hive Mind", "/r/Minecraft", "macguy8 (Collin)"});
