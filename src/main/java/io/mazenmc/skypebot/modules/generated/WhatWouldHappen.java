...
public class WhatWouldHappen implements Module {
    ...
    private static final HashMap<String, String[]> DATA = new HashMap<String, String[]>() {{
        ...
        put("members", new String[]{"Mazen", "Luke", "Filip", "Jodie", "Vilsol", "Matthew", "Richmond", "Nick", "Gilles", "Mazen's GF", "Callan's Ex", "Mattrick's Ex in Colorado", "Chaska", "Rich's FWB", "Justis", "Callan"});
